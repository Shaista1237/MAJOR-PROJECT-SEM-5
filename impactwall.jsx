...
const ImpactWall = () => {
  ...
  const stories = [
    {
      ...
      beforeImg:
        "https://i.pinimg.com/1200x/da/a9/93/daa993d245e6ccf4cd2c5420433bbd05.jpg",
      afterImg:
        "https://i.pinimg.com/1200x/35/c3/0b/35c30b07f39d77aa7d5f74ac02a68a3e.jpg",
      description:
    ...
    },
    {
      ...
      beforeImg:
        "https://i.pinimg.com/1200x/ad/05/f6/ad05f6d194e635fdee5f8849d5119d4d.jpg",
      afterImg:
        "https://i.pinimg.com/1200x/12/21/0f/12210ffd04d138553185686c7fefc042.jpg",
      description:
    ...
    },
    {
      ...
      beforeImg:
        "https://i.pinimg.com/736x/b6/91/38/b691382fe88bdce4e10ec7f434e8bd7d.jpg",
      afterImg:
        "https://i.pinimg.com/736x/ec/26/3d/ec263d4203aa7b73bd29dea474a2289b.jpg",
      description:
    ...
    },
    {
      ...
      beforeImg:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPue112T1cZSX5iF9eJt7mH7awLKEBedkvrw&s",
      afterImg:
        "https://i.pinimg.com/1200x/e9/8a/cc/e98acc79ba39a0dd08ae709027182602.jpg",
      description:
    ...
    },
    {
      ...
      beforeImg:
        "https://i.pinimg.com/1200x/03/14/39/0314395201f3c3bbb395320049b73eb6.jpg",
      afterImg:
        "https://i.pinimg.com/1200x/5f/68/87/5f688736483a11fb24cb44d74c3bc67e.jpg",
      description:
    ...
    },
    {
      ...
      beforeImg:
        "https://i.pinimg.com/736x/ba/e2/11/bae211cd22d9d659bae95688a98b85c9.jpg",
      afterImg:
        "https://i.pinimg.com/1200x/06/74/1f/06741f4e29fa189f63ac64caff70e5df.jpg",
      description:
    ...
    },
    {
      ...
      beforeImg:
        "https://i.pinimg.com/1200x/9b/32/85/9b328531cc4053489fed3d1f1726ee48.jpg",
      afterImg:
        "https://i.pinimg.com/1200x/18/ed/47/18ed4799aa9d6ba64466873b01ae607b.jpg",
      description:
  ...
  const handleDonationSubmit = (e) => {
    ...
    setStats((prev) => ({
      ...prev,
      donations: prev.donations + Number(donationAmount),
    }));
  ...
  return (
    <div className="container my-5 text-light">
      <p className="text-center fs-2 fw-bold mb-5">Impact Wall</p>
      ...
      <div className="row text-center g-3 mb-5">
        {[
          ...
          { icon: <FaBook />, label: "Stories", value: stats.stories },
        ].map((stat, idx) => (
          <div key={idx} className="col-6 col-md-3">
            <div className="glass-card p-3 h-100 shadow-sm">
              <div className="mb-2 fs-3">{stat.icon}</div>
              <p className="fw-bold mb-1">{stat.value}</p>
      ...
      <div className="row g-4 mb-5">
        <div className="col-md-6">
          <div className="glass-card p-4 h-100 shadow-sm">
            <p className="fw-bold fs-5">Make a Donation</p>
        ...
        <div className="col-md-6">
          <div className="glass-card p-4 h-100 shadow-sm">
            <p className="fw-bold fs-5">Join as Volunteer</p>
      ...
      {/* Trivia */}
      <div className="glass-card p-4 mb-5 shadow-sm text-center">
        <p className="fw-bold fs-5">Trivia Challenge</p>
        <p className="small mb-3">{triviaQuestion.question}</p>
        <div className="d-flex flex-wrap justify-content-center gap-2 mb-3">
          {triviaQuestion.options.map((opt, idx) => (
            <button
              key={idx}
              className={`glass-btn btn-sm ${selectedOption === opt ? "active" : ""}`}
        ...
        <div className="d-flex align-items-center justify-content-center gap-3">
          <button className="glass-btn btn-sm" onClick={handleTrivia}>
            Submit
          </button>
          {triviaMsg && <span className="text-success fw-bold">{triviaMsg}</span>}
          <span className="ms-auto small fw-bold">
            Points: {points} <FaStar className="text-warning" />
          </span>
        </div>
      </div>
      ...
      <section className="my-5">
        <h2 className="text-center fw-bold mb-4">Global Impact Stories</h2>
        <div className="position-relative">
          <button className="carousel-btn-left" onClick={() => scrollCarousel("left")}>
            &lt;
          </button>
          <div
            className="d-flex overflow-auto px-2 stories-container"
            ref={carouselRef}
          >
            {stories.map((story) => (
              <div
                key={story.id}
                className="glass-card story-card flex-shrink-0 me-3"
                style={{ minWidth: "250px", maxWidth: "250px", height: "320px" }}
                onClick={() => {
              ...
              >
                ...
                <div className="p-2">
                  ...
                  <p className="small">{story.description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <Modal show={showStoryModal} onHide={() => setShowStoryModal(false)} centered>
        ...
        <Modal.Body>
          <div className="d-flex flex-wrap justify-content-center gap-3">
            <div>
              <p className="fw-bold text-primary mb-1">Before Crisis</p>
              <img
            ...
            <div>
              <p className="fw-bold text-success mb-1">After Recovery</p>
              <img
          ...
          <p className="mt-3">{selectedStory?.description}</p>
        </Modal.Body>
        <Modal.Footer>
      ...
      <div className="glass-card shadow-sm text-center p-4 mb-5">
        <p className="fw-bold fs-5 mb-2">Milestones & Achievements</p>
        <p className="small mb-3">
          Complete challenges, earn points & badges, and contribute to impactful
          missions globally.
        </p>
